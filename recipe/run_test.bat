...
set "PC_LIBS=soup-2.4.lib sqlite3.lib ws2_32.lib xml2.lib iconv.lib z.lib psl.lib ws2_32.lib icuuc.lib icudt.lib brotlidec.lib brotlicommon.lib gio-2.0.lib intl.lib iconv.lib shlwapi.lib dnsapi.lib iphlpapi.lib ws2_32.lib gmodule-2.0.lib intl.lib iconv.lib z.lib gobject-2.0.lib intl.lib iconv.lib libffi.lib glib-2.0.lib intl.lib iconv.lib pcre2-8.lib ws2_32.lib winmm.lib"
